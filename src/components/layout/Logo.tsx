...
/** Símbolo da marca: crosshair/radar minimalista. */
export function LogoMark({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 32 32" fill="none" className={cn('h-8 w-8', className)} aria-hidden>
      <circle cx="16" cy="16" r="10" stroke="var(--color-primary)" strokeWidth="1.4" opacity="0.4" />
      <circle cx="16" cy="16" r="5.5" stroke="var(--color-primary)" strokeWidth="1.4" opacity="0.85" />
      <circle cx="16" cy="16" r="1.9" fill="var(--color-lime)" />
    ...
    <div className="flex items-center gap-2.5">
      ...
      {!collapsed && (
        <div className="leading-none">
          <p className="text-[13px] font-extrabold tracking-[0.14em] text-ink">
            SEGATTO'S <span className="text-primary">LEADS</span>
          </p>
          <p className="mt-1 font-mono text-[8.5px] font-medium tracking-[0.3em] text-faint">
